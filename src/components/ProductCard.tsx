  ...
  return (
    <article className="flex flex-col justify-between p-3 border rounded-xl border-zinc-200 bg-zinc-50 hover:shadow-md">
      ...
      <div className="flex flex-col gap-2 pt-4 rounded-b-lg">
        ...
        <h4 className="h-8 text-sm font-medium leading-4 xs:h-12 line-clamp-2 xs:line-clamp-3">
          {title}
        </h4>
      ...
      <button
        type="button"
        className="flex flex-row items-center self-end justify-center w-full gap-1.5 py-1 font-bold text-white transition duration-300 rounded-lg bg-pumpkin-600 hover:bg-pumpkin-500"
      >
